...
public class CastleHiredGuardDAO {
  ...
  public void load(Castle r) {
    ...
    try {
      ...
      _log.error("CastleHiredGuardDAO:load(Castle): " + var11, var11);
    } finally {
  ...
  public void insert(Residence residence, int itemId, Location loc) {
    ...
    try {
      ...
      _log.error("CastleHiredGuardDAO:insert(Residence, int, Location): " + var10, var10);
    } finally {
  ...
  public void delete(Residence residence, ItemInstance item) {
    ...
    try {
      ...
      _log.error("CastleHiredGuardDAO:delete(Residence): " + var9, var9);
    } finally {
      DbUtils.closeQuietly(con, statement);
    }
  ...
  public void delete(Residence residence) {
    ...
    try {
      ...
      _log.error("CastleHiredGuardDAO:delete(Residence): " + var8, var8);
    } finally {
      DbUtils.closeQuietly(con, statement);
    }
