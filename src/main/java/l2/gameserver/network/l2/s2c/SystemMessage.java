...
public class SystemMessage extends L2GameServerPacket {
  ...
  private List<SystemMessage.Arg> args;
  ...
  public SystemMessage addString(String text) {
    this.args.add(new SystemMessage.Arg(0, StringUtils.defaultString(text)));
    return this;
  }

  public SystemMessage addNumber(int number) {
    this.args.add(new SystemMessage.Arg(1, number));
    return this;
  }

  public SystemMessage addNumber(long number) {
    this.args.add(new SystemMessage.Arg(6, number));
    return this;
  }
  ...
  public SystemMessage addName(Creature cha) {
    if (cha == null) {
      ...
      return cha.getNpcId() <= 0 ? this.addString(cha.getName()) : this.addNpcName(cha.getNpcId());
    }
  }

  public SystemMessage addDoorName(int id) {
    this.args.add(new SystemMessage.Arg(11, new Integer(id)));
    return this;
  }

  public SystemMessage addNpcName(int id) {
    this.args.add(new SystemMessage.Arg(2, new Integer(1000000 + id)));
    return this;
  }

  public SystemMessage addItemName(int id) {
    this.args.add(new SystemMessage.Arg(3, id));
    return this;
  }

  public SystemMessage addZoneName(Location loc) {
    this.args.add(new SystemMessage.Arg(7, loc));
    return this;
  }

  public SystemMessage addSkillName(int id, int level) {
    this.args.add(new SystemMessage.Arg(4, new int[]{id, level}));
    return this;
  }

  public SystemMessage addElemntal(int type) {
    this.args.add(new SystemMessage.Arg(9, type));
    return this;
  }

  public SystemMessage addSystemString(int type) {
    this.args.add(new SystemMessage.Arg(13, type));
    return this;
  }

  public SystemMessage addInstanceName(int type) {
    this.args.add(new SystemMessage.Arg(10, type));
    return this;
  }

  public SystemMessage addFortId(int number) {
    this.args.add(new SystemMessage.Arg(5, number));
    return this;
  }
  ...
  protected final void writeImpl() {
    ...
    if (activeChar != null) {
      ...
      while(var2.hasNext()) {
        SystemMessage.Arg e = (SystemMessage.Arg)var2.next();
        this.writeD(e.type);
        switch(e.type) {
          case 0:
