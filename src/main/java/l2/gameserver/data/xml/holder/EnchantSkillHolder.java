...
public class EnchantSkillHolder extends AbstractHolder {
  ...
  public void addEnchantSkill(SkillEnchant skillEnchant) {
    ...
    Map<Integer, SkillEnchant> skillEnchantLevels = this._skillsEnchantLevels.computeIfAbsent(skillId, k -> new TreeMap<>());

    ((Map)skillEnchantLevels).put(skillEnchant.getSkillLevel(), skillEnchant);
    Map<Integer, Map<Integer, SkillEnchant>> skillEnchantRoutes = this._skillsEnchantRoutes.computeIfAbsent(skillId, k -> new TreeMap<>());
  ...
  public SkillEnchant getSkillEnchant(int skillId, int skillLvl) {
    Map<Integer, SkillEnchant> skillEnchantLevels = this._skillsEnchantLevels.get(skillId);
    return skillEnchantLevels == null ? null : skillEnchantLevels.get(skillLvl);
  }
  ...
  public Map<Integer, Map<Integer, SkillEnchant>> getRoutesOf(int skillId) {
    Map<Integer, Map<Integer, SkillEnchant>> skillEnchantRoutes = this._skillsEnchantRoutes.get(skillId);
