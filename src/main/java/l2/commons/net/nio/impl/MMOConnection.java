...
public class MMOConnection<T extends MMOClient> {
  ...
  protected void disableReadInterest() {
    try {
      ...
      log.error("disableReadInterest: eMessage={}, eClause={} eClass={}", e.getMessage(), e.getCause(), e.getClass());
    }
  ...
  protected void scheduleWriteInterest() {
    try {
      ...
      log.error("scheduleWriteInterest: eMessage={}, eClause={} eClass={}", e.getMessage(), e.getCause(), e.getClass());
    }
