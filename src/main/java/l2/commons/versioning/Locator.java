...
public final class Locator {
  ...
  public static String fromURI(String uri) {
    ...
    try {
      ...
      log.error("fromURI: eMessage={}, eClause={} eClass={}", e.getMessage(), e.getCause(), e.getClass());
    }
  ...
  public static File getToolsJar() {
    ...
    try {
      ...
      try {
        ...
        log.error("getToolsJar: eMessage={}, eClause={} eClass={}", e.getMessage(), e.getCause(), e.getClass());
      }
    }
